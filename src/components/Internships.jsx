...
const InternshipCard = ({ intern, index }) => (
  ...
  >
    <div>
      ...
      {/* Skills / Details */}
      <div className="mb-6">
        <h4 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2">Key Details:</h4>
    ...
    {intern.badge === "EDUCATION" && (
      <div className="pt-4 border-t border-slate-200">
        <h4 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-3">Interested In:</h4>
